...
- Rename the base package `bmarshall.boilerplate` to your preferred name. *[How to]*
...
```java
import bmarshall.boilerplate.domain.executor.Executor;
import bmarshall.boilerplate.domain.executor.MainThread;
import bmarshall.boilerplate.domain.interactors.WelcomingInteractor;
import bmarshall.boilerplate.domain.interactors.base.AbstractInteractor;
import bmarshall.boilerplate.domain.repository.MessageRepository;
```
